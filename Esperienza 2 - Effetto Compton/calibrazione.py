...
def calibrazione(ch, dch):
	...
	m = linear.GetParameter(1)
	m_err = linear.GetParError(1)
	q = linear.GetParameter(0)
	q_err = linear.GetParError(0)
	...
	return m, m_err, q, q_err, c, c_err, b, b_err, a, a_err
