...
compton=plb.loadtxt('15_02_calibrazione680V_5min.dat', unpack=True)
...
hist_compton=TH1F("compton", "Spettro in canali PMT01", num_bin, 0, num_bin)
i=0
...
legend_compton.AddEntry("", f"V_{{al}}=680V; V_{{thr}}=-40.7mV", "")
legend_compton.Draw()
