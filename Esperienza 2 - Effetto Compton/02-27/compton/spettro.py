...
compton=plb.loadtxt('compton_63deg_27feb.dat', unpack=True)
...
hist_compton=TH1F("compton", "Spettro Compton - #theta=30 deg", num_bin, 0, num_bin)
i=0
...
legend_compton.AddEntry("","Data di acquisizione : 27/02/24, durata: 18h", "")
...
legend_compton.AddEntry("", f"V_{{al}}=680V; V_{{thr, 1}}=-20.7mV; V_{{thr, 1}}=-51.0mV", "")
legend_compton.Draw()
