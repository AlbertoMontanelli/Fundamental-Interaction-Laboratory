...
void decode(const char *filename) {
   ...
   double hours, seconds, minutes, mseconds;
   char rootfile[256];
   ...
   rec->Branch("day", &eh.day, "day/b");
   rec->Branch("hours", &eh.hour, "hours/b");
   rec->Branch("minutes", &eh.minute, "minutes/b");
   rec->Branch("seconds", &eh.second, "seconds/b");
   rec->Branch("mseconds", &eh.millisecond, "mseconds/i");
